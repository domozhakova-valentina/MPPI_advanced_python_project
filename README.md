...
- [ ] Настройка структуры проекта - 1 день
- [ ] Создание базовых интерфейсов и абстрактных классов - 1 день
- [ ] Написание модели маятника - 1 день

### Шаг 2: Реализация алгоритмов (3 дня)
- [ ] NumPy реализация - 1 день
- [ ] JAX реализация - 1 день
- [ ] C++ реализация с PyBind11 - 1 день

### Шаг 3: Визулизация результатов (2 дня)
- [ ] Написание классов и функций для визуализации - 1 день
- [ ] Создание Jupyter Notebook с интерактивными элементами - 1 день


### Шаг 4: Тестирование и развертывание (2 дня)
- [ ] Написание тестов и исправление найденных багов - 1 день
- [ ] Докеризация - 1 день
...
- Реализация тестов направленных на проверку работоспособности каждой реализации при различных параметрах, включая экстремальные значения.
- Проверка правильности расчётов модели
